...
@app.route('/users/new/', methods=['POST'], endpoint='new_user')
@ensure_session
@ensure_role(RoleEnum.ADMIN)
def new_user():
...
@app.route('/users/<string:disc_id>/delete/', methods=['POST'], endpoint='delete_user')
@ensure_session
@ensure_role(RoleEnum.ADMIN)
...
@app.route('/users/<string:disc_id>/edit', methods=['POST'], endpoint='edit_user')
@ensure_session
@ensure_role(RoleEnum.ADMIN)
